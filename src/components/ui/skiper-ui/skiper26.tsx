...
/**
 * Skiper UI 26 — click-to-fill theme toggle (View Transitions API).
 *
 * Source: https://skiper-ui.com/v1/skiper26 (registry).
 * Original concept: rudrodip — https://github.com/rudrodip/theme-toggle-effect
 *
 * Trimmed in this project to keep only the reusable parts (hook + button +
 * animation factory). The demo Skiper26/Options components were removed.
 *
 * Free to use with attribution per Skiper UI license.
 */
