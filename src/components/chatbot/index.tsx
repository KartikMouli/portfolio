                            ...
                            <div className="grid grid-cols-1 gap-1.5">
                              {SUGGESTED_QUESTIONS.map((question, index) => (
                                <Button
                                  ...
                                  onClick={() =>
                                    handleFaqClick({ question, answer: '' })
                                  }
                                >
                              ...
                              >
                                ...
                                >
                                  <ReactMarkdown
                                    components={{
                                      p: ({ children }) => (
                                        <p className="mb-1.5 last:mb-0 text-sm">
                                          {children}
                                        </p>
                                      ),
                                      ul: ({ children }) => (
                                        <ul className="list-disc pl-3 mb-1.5 text-sm">
                                          {children}
                                        </ul>
                                      ),
                                      ol: ({ children }) => (
                                        <ol className="list-decimal pl-3 mb-1.5 text-sm">
                                          {children}
                                        </ol>
                                      ),
                                      li: ({ children }) => (
