...
export const FAQ_DATA: FAQ[] = [
  {
    ...
    answer:
      "I'm Kartik Mouli, a Full-Stack Web Developer from Nashik, Maharashtra. I graduated from IITP in Computer Science (CSE'24) and currently work as a Full Stack Developer Intern at Unizoy.",
  },
  {
    question: 'What technologies do you use?',
    answer:
      "I specialize in modern web technologies including React, Next.js, TypeScript, Node.js, and various other frontend and backend technologies. I'm particularly skilled in building responsive and performant web applications.",
  },
  {
    question: 'Can I see your projects?',
    answer:
      'Yes! I have several featured projects including this portfolio website, and other web applications. You can find them in the projects section of my portfolio.',
  },
  {
    question: 'How can I contact you?',
    answer:
      "You can reach me through the social links in my portfolio or send me a message using the contact form. I'm always open to new opportunities and collaborations.",
  },
];
